...
package org.aswing
{
	 ...
	 * Defines four interrelated number properties: minimum, maximum, extent
	 * and value.  These four numbers define two nested ranges like this:
	 * <pre>
	...
	public interface BoundedRangeModel
	{
		 ...
		 */
		function setMinimum( newMinimum:Number ):void;
		 ...
		 * @see #addChangeListener()
		 */
		function setMaximum( newMaximum:Number ):void;
		 ...
		 */
		function setValue( newValue:Number, programmatic:Boolean = true ):void;
		 ...
		 * @see #setValue()
		 */
		function setExtent( newExtent:Number ):void;
		 ...
		 * @see org.aswing.event.InteractiveEvent#isProgrammatic()
		 */
		function setRangeProperties( value:Number, extent:Number, min:Number, max:Number, adjusting:Boolean, programmatic:Boolean = true ):void;
