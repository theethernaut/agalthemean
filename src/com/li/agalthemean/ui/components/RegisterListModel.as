package com.li.agalthemean.ui.components
{
	...
	public class RegisterListModel extends AbstractListModel implements MutableListModel, List
	{
		 ...
		 */
		public function RegisterListModel( initalData:Array = null ) {
			super();
			if( initalData != null ) {
		...
		public function updateData( data:Array ):void {
			_elements = data.concat();
		}

		public function get( i:int ):* {
			return _elements[i].toStringExtended();
		}
		...
		public function toString():String {
			return "RegisterListModel : " + _elements.toString();
		}
	}
}