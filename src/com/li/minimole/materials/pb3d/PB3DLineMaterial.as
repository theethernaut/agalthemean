 ...
 */
public class PB3DLineMaterial extends PB3DMaterialBase implements IColorMaterial
{
    ...
    public function PB3DLineMaterial(color:uint = 0xFFFFFF, thickness:Number = 0.02)
    {
        super();
